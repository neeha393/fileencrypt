...
<body>
    ...
    <h2>This project was developed by team 3 as a part of Cyber Security Internship.This project is designed to secure the organizations in Real World from Cyber Frauds performed by Hackers</h2>
        ...
        <table>
            ...
            <tr>
              <td>Project Name</td>
              <td>Secured File Encryption and Decryption</td>
...
def button1_clicked():
    ...
    encrypt_button = tk.Button(file_window,text="Encrypt File", font=("Arial", 14 , "bold"),bg ="plum", fg="white",command=encrypt_file)
...
def button2_clicked():
    ...
    decrpyt_button = tk.Button(file_window, text="Decrypt file", font=("Arial", 14, "bold"), bg="red", fg="white",command=decrpyt_file)
...
project_label = tk.Label(root,text="File Encryption And Decrpytion", font=("Arial", 18,"bold"), bg="black", fg="white")
...
button1 = tk.Button(button_frame, text ="Encrypt files", font=("Arial", 14, "bold"), padx=10, pady=5,command=button1_clicked, bg="red", fg="white")
button2 = tk.Button(button_frame, text="Decrpty files", font=("Arial", 14, "bold"), padx=10, pady=5, command=button2_clicked,bg="red", fg="white")
